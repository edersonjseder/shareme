...
const Pin = ({ pin: { postedBy, image, _id, destination, save } }) => {
    ...
    // Example explanation from snippet above:
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex gap-2">
                                <a
                                    ...
                                    download
                                    onClick={(e) => e.stopPropagation()} // Avoids the click to propagate through the image, the file will be downloaded and is not going to detail
